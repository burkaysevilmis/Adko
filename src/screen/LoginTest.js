...
export default class LoginTest extends Component {
  ...
  render() {
    return (
      <View style={{flex:1}}>
      <View style={{height:'65%',backgroundColor:'#404E67',alignItems:'center'}}>
      ...
      <View style={{   shadowColor: 'rgba(46, 229, 157, 0.4)',
                        ...
                        elevation: 8,
                        shadowRadius: 20,
                        shadowOffset: { width: 1, height: 8 },width:'80%',height:'30%',backgroundColor:'#F8FAF9',borderRadius:10,position:'absolute',bottom:'15%',alignSelf:'center'}}>
