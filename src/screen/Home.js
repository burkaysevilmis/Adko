...
<View style={{ width:width,height:500, alignItems: 'center' }}>
          ...
          <View style={{ width: '90%', height: '60%', borderRadius: 15, marginTop: 15 }}>
            <View style={{ height: '8%', justifyContent: 'center' }}>
              <Text style={{ alignSelf: 'center', fontSize: 18 }}>MİGROS REYON FOTOĞRFLARI</Text>
            </View>
            ...
            <View style={{ height: '10%', paddingLeft: 10, paddingTop: 5 }}>
              <Text style={{ fontSize: 14 }}>Ziyaret Ettiğiniz noktalarda öncesi ve sonrası fotoğraflarınızı
sistem üzerinden iletmenizi rica ederiz.</Text>
            </View>
          ...
          <View style={{ width: '90%', height: '5%', backgroundColor: '#2CC3D9', borderRadius: 15, marginTop: 30, alignItems: 'center', paddingLeft: 10, flexDirection: 'row' }}>
      ...
      <View style={styles.container}>
         <View style={styles.Box}>
            ...
            <View style={styles.ImageBox}>
              <Image style={styles.ImageStyle} resizeMode={'cover'} source={require('../images/test.jpg')} />
            </View>
          </View>
         <ScrollView>
        {veri}</ScrollView>
